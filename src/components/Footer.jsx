...
const Footer = () => {
    return (
        <footer className="bg-secondary-bg text-black econdary dark:bg-gray-800 dark:text-white pt-20 mt-5 pb-5">
            <div className="section_container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 px-8">
            ...
            {/* Bottom Footer */}
            <div className="mt-12 section_container flex flex-col sm:flex-row sm:justify-between sm:items-center sm:text-center gap-4 text-left text-black dark:bg-gray-800 dark:text-white border-t border-gray-300 pt-4">
